...
__global__ void gen_kernel(uint8_t *cw_np1_dev, uint8_t *cws_dev, uint8_t *alpha_dev,
    uint8_t *beta_dev, uint8_t *sbuf_dev) {
...
int main() {
    ...
    gen_kernel<<<block_num, kThreadsPerBlock>>>(
        cw_np1_dev, cws_dev, alpha_dev, beta_dev, sbuf_gen_dev);
