...
// From https://github.com/pytorch/csprng/blob/3f17f1f96f6d3bd8db535e2f59aa1338c7337f85/torchcsprng/csrc/aes.inc
...
TORCH_CSPRNG_HOST_DEVICE void encrypt(uint8_t *state, const uint8_t *RoundKey) {
